...
class Command(BaseCommand):
    help = 'Добавить разрешение на удаление пользователей существующему администратору'
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f'Разрешение на удаление пользователей добавлено пользователю {admin_email}.'))
